...
class LLVM::ABI
  describe AVR do
    ...
    describe "align" do
      ...
      it "for pointer" do
        abi.align(LLVM::Int8.pointer).should eq(2)
      end
    ...
    describe "size" do
      ...
      it "for pointer" do
        abi.size(LLVM::Int8.pointer).should eq(2)
      end
      ...
      it "for double" do
        abi.size(LLVM::Double).should eq(4)
      end
    ...
    describe "abi_info" do
      ...
      it "does with structs less than 8 bits" do
        str = LLVM::Type.struct([LLVM::Int8])
        arg_types = [str]
        return_type = str
        ...
        info.arg_types[0].should eq(ArgType.direct(str, cast: LLVM::Type.struct([LLVM::Int8])))
        info.return_type.should eq(ArgType.indirect(str, attr: LLVM::Attribute::StructRet))
      end

      it "does with structs less than 32 bits" do
        str = LLVM::Type.struct([LLVM::Int8, LLVM::Int8, LLVM::Int8])
        arg_types = [str]
        return_type = str
        ...
        info.arg_types[0].should eq(ArgType.direct(str, cast: LLVM::Type.struct([LLVM::Type.int(24)])))
        info.return_type.should eq(ArgType.indirect(str, attr: LLVM::Attribute::StructRet))
      end
      ...
      it "does with structs less than 64 bits" do
        ...
        info.arg_types[0].should eq(ArgType.direct(str, cast: LLVM::Type.struct([LLVM::Int32])))
        info.return_type.should eq(ArgType.indirect(str, attr: LLVM::Attribute::StructRet))
      end
      ...
      it "does with structs between 64 and 128 bits" do
        ...
        info.arg_types[0].should eq(ArgType.direct(str, cast: LLVM::Type.struct([LLVM::Int32, LLVM::Int32, LLVM::Int32, LLVM::Int32]), pad: LLVM::Int32))
        info.return_type.should eq(ArgType.indirect(str, Attribute::StructRet))
      end

      it "does with structs above 128 bits" do
        ...
        info.arg_types[0].should eq(ArgType.direct(str, cast: LLVM::Type.struct([LLVM::Int32, LLVM::Int32, LLVM::Int32, LLVM::Int32, LLVM::Int32, LLVM::Int32]), pad: LLVM::Int32))
        info.return_type.should eq(ArgType.indirect(str, Attribute::StructRet))
      end
    end
{% end %}
